...
function ProfilePreview({ profile }) {
  return (
    <Link
      ...
      state={{ profile }}
      className="flex w-full items-center gap-2 rounded-lg border-2 border-transparent bg-black p-2 hover:border-white focus:border-2 focus:border-white focus:ring-0 focus:outline-hidden"
