    ...
    <div className="flex w-full flex-col gap-4 bg-black">
      ...
      {searchResults.map((profile, index) => (
        <Link
          ...
          state={{ profile }}
          className="flex items-center gap-2 rounded-lg border-2 border-transparent bg-black p-2 hover:border-white focus:border-2 focus:border-white focus:outline-none focus:ring-0"
