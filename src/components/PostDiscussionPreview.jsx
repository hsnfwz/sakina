...
function PostDiscussionPreview({ postDiscussion }) {
  return (
    <Link
      ...
      className="flex w-full flex-col gap-4 rounded-lg border-2 border-transparent p-2 hover:border-white focus:border-2 focus:border-white focus:ring-0 focus:outline-hidden"
      ref={null}
    >
